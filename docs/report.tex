...
\author{\IEEEauthorblockN{1\textsuperscript{st} Caio Escorcia Lima Dourado}
\IEEEauthorblockA{\textit{ENSTA Paris} \\
\textit{Institut Polytechnique de Paris}\\
Palaiseau, France \\
caio.escorcio@ensta-paris.fr}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Gustavo Loiola Dos Santos}
\IEEEauthorblockA{\textit{ENSTA Paris} \\
\textit{Institut Polytechnique de Paris}\\
Palaiseau, France \\
...
\subimport{sections/}{times.tex}
\subimport{sections/}{vectorization.tex}
\subimport{sections/}{openmp.tex}
\subimport{sections/}{mpi_population.tex}
\subimport{sections/}{subdomain.tex}
