...
\begin{minipage}{0.48\columnwidth}
    \centering
    \safeincludegraphics[width=\linewidth]{../../distributed_subdomain_mpi/results/sweeps_render_food10/plots/mpi_total_breakdown_ants5000.png}
    \\[-2mm]
...
\begin{minipage}{0.48\columnwidth}
    \centering
    \safeincludegraphics[width=\linewidth]{../../distributed_subdomain_mpi/results/sweeps_render_food10/plots/mpi_total_breakdown_ants40000.png}
    \\[-2mm]
...
\begin{minipage}{0.62\columnwidth}
    \centering
    \safeincludegraphics[width=\linewidth]{../../distributed_subdomain_mpi/results/sweeps_render_food10/plots/mpi_total_breakdown_ants160000.png}
    \\[-2mm]
