#ifndef RAND_GENERATOR_HPP
#define RAND_GENERATOR_HPP
...
struct RandomGenerator {
    ...
    RandomGenerator(std::size_t seed, double min_val, double max_val)
        : m_seed(static_cast<std::uint32_t>(seed)), m_min_val(min_val), m_max_val(max_val) {}
...
inline std::int32_t rand_int32(std::int32_t min_val, std::int32_t max_val, std::size_t& seed) {
