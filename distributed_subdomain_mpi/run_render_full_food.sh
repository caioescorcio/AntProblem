...
RESULTS_DIR="results/sweeps_render_full_food"
mkdir -p "$RESULTS_DIR"
...
for ants in "${ANTS_LIST[@]}"; do
  for threads in "${THREADS_LIST[@]}"; do
    ...
    echo "Running distributed full-render sweep: mpi_ranks=${threads}, ants=${ants}"
...
python3 ./plot_sweep_times_fullrender.py \
